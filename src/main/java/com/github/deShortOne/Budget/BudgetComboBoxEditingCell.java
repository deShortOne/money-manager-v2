...
public class BudgetComboBoxEditingCell<T extends BaseDataValue> extends ComboBoxTableCell<Transaction, T> {
	private ComboBox<T> comboBox = new ComboBox<>();

	public BudgetComboBoxEditingCell(ArrayList<T> list) {
		createComboBox(list);
	}
